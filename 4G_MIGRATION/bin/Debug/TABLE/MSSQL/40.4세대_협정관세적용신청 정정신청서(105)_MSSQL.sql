...
/* 송신_협정관세적용 정정신청 공통사항 */
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'CUSAGREEJ')
 BEGIN
  DROP TABLE CUSAGREEJ
 END;
...
/* 송신_협정관세적용 정정신청 상세내역 */
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'CUSAGREEJ_D')
 BEGIN
  DROP TABLE CUSAGREEJ_D
 END;
...
/* 송신_협정관세적용 정정신청 란추가 */
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'CUSAGREEJ_D2')
 BEGIN
  DROP TABLE CUSAGREEJ_D2
 END;
...
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'BFCUSAGREEM')
 BEGIN
  DROP TABLE BFCUSAGREEM
 END;
...
/* 송신_협정관세적용(정정)신청 란사항 */
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'BFCUSAGREED')
 BEGIN
  DROP TABLE BFCUSAGREED
 END;
