...
/* 송신_협정관세적용신청 공통사항 */
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'cusagreem')
 BEGIN
  DROP TABLE cusagreem
 END;
...
/* 송신_협정관세적용신청 란사항 */
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'cusagreed')
 BEGIN
  DROP TABLE cusagreed
 END;
